...
sequenceDiagram
    ...
    FB->>DB: SELECT efekty_uczenia_sie, godziny_zrealizowane
    DB-->>FB: 13 efektów + suma godzin
    ...
    alt Niekompletne dane
        ...
        alt UOPZ nie akceptuje
            ...
            DB-->>FB: OK
            FB->>DB: SELECT student, efekty, oceny, godziny, podpisy
            DB-->>FB: komplet danych
            FB->>PDF: render_potwierdzenie_efektow(dane)
            PDF-->>FB: zal_nr4.pdf
            FB->>DB: INSERT dokument {typ: "zal_nr4"}
